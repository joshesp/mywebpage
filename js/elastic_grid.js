...
***************************************************************************/
        ...
        Preview.prototype = {
            create : function() {
                ...
                this.$containerInfoWork = $('<div class="og-container-info-gallery"></div>').append(this.$fullimage, this.$details)

                this.$previewInner = $( '<div class="og-expander-inner"></div>' ).append( this.$closePreview, this.$containerInfoWork );
